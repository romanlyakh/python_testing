...
def test_add_contact(app):
        app.open_home_page()
        app.contact.add(Contact(firstname="Петр", middlename="Анатольевич", lastname="Иванов", nickname="ivanov", title="test_title", company="company_test", address="address_test",
